        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.id);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    updated_at = table.Column<DateTime>(type: "timestamp", nullable: false, defaultValueSql: "'0000-00-00 00:00:00'"),
                    created_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    updated_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    navigation_item_id = table.Column<int>(type: "int(11)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.id);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    execution_id = table.Column<int>(type: "int(11)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => new { x.vehicle_id, x.employee_id });
                    table.ForeignKey(
                        name: "EmployeeID",
                        column: x => x.employee_id,
                        principalTable: "employee",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    vehicle_type_id = table.Column<int>(type: "integer", nullable: true),
                    vehicle_id = table.Column<int>(type: "integer", nullable: true),
                    tag_id = table.Column<int>(type: "int(11)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pump_transcation_id = table.Column<int>(type: "int(11)", nullable: true),
                    driver_id = table.Column<int>(type: "int(11)", nullable: true),
                    ...
                    is_modified = table.Column<short>(type: "tinyint(4)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.delivery_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    policy_execution_id = table.Column<int>(type: "int(11)", nullable: true),
                    tank_id = table.Column<int>(type: "integer", nullable: false),
                    detected_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int(11)", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    policy_id = table.Column<int>(type: "int(11)", nullable: false),
                    execution_start_time = table.Column<DateTime>(type: "datetime", nullable: false),
                    executed_by = table.Column<string>(type: "text", nullable: false),
                    execution_end_time = table.Column<DateTime>(type: "datetime", nullable: true),
                    status = table.Column<int>(type: "int(11)", nullable: false),
                    tanks_evaluated = table.Column<int>(type: "int(11)", nullable: false, defaultValue: 0),
                    discrepancies_detected = table.Column<int>(type: "int(11)", nullable: false, defaultValue: 0),
                    tanks_reconciled = table.Column<int>(type: "int(11)", nullable: false, defaultValue: 0),
                    reconciliation_failures = table.Column<int>(type: "int(11)", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    adjustment_type = table.Column<int>(type: "tinyint(4)", nullable: false, comment: "0=Increase, 1=Decrease, 2=Correction"),
                    ...
                    status = table.Column<int>(type: "tinyint(4)", nullable: false, defaultValue: 1, comment: "0=Pending, 1=Approved, 2=Rejected"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fuel_rule_set_id = table.Column<int>(type: "int(11)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    master_rfid_tag = table.Column<int>(type: "int(11)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    require_acknowledgment = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"),
                    created_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    updated_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => new { x.site_id, x.user_id });
                    table.ForeignKey(
                        name: "SiteID",
                        column: x => x.site_id,
                        principalTable: "site",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.vehicle_trip_cluster_snapshot_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.vehicle_trip_group_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_night_shift = table.Column<decimal>(type: "numeric(20,0)", nullable: false, defaultValueSql: "b'0'"),
                    is_kmper_liter = table.Column<decimal>(type: "numeric(20,0)", nullable: false, defaultValueSql: "b'0'"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int(11)", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    date_time = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    fuel_grade_id = table.Column<int>(type: "int(11)", nullable: false),
                    ...
                    tank_filling_percentage = table.Column<int>(type: "int(11)", nullable: true),
                    configuration_id = table.Column<string>(type: "character varying(45)", maxLength: 45, nullable: true),
                    packet_id = table.Column<int>(type: "int(11)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int(11)", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    source_tank_id = table.Column<int>(type: "int(11)", nullable: true),
                    destination_tank_id = table.Column<int>(type: "int(11)", nullable: true),
                    amount = table.Column<decimal>(type: "numeric(10,0)", precision: 10, scale: 0, nullable: true),
                    transfer_date = table.Column<DateTime>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.vehicle_trip_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.vehicle_trip_out_of_bounds_event_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.vehicle_trip_override_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.vehicle_trip_state_id);
                    table.ForeignKey(
