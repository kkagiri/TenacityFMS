...
{
    /// <summary>
    /// Entity Framework configuration for DeviceProviderMappingEntity
    /// </summary>
    public class DeviceProviderMappingEntityConfiguration : IEntityTypeConfiguration<DeviceProviderMappingEntity>
    {
        public void Configure(EntityTypeBuilder<DeviceProviderMappingEntity> builder)
        {
