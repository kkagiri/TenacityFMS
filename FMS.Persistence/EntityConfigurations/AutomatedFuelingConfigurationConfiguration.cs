...
namespace FMS.Persistence.EntityConfigurations
{
    public class AutomatedFuelingConfigurationConfiguration : IEntityTypeConfiguration<AutomatedFuelingConfiguration>
    {
        public void Configure(EntityTypeBuilder<AutomatedFuelingConfiguration> builder)
        {
            ...
            builder.Property(e => e.EnableFuelRulesCheck)
                .HasColumnName("EnableFuelRulesCheck")
                .HasColumnType("tinyint(1)")
                .HasDefaultValue(true);

            builder.Property(e => e.EnableFuelCapacityValidation)
                .HasColumnName("EnableFuelCapacityValidation")
                .HasColumnType("tinyint(1)")
                .HasDefaultValue(true);

            builder.Property(e => e.EnableGPSFuelLevelCheck)
                .HasColumnName("EnableGPSFuelLevelCheck")
                .HasColumnType("tinyint(1)")
                .HasDefaultValue(true);
