    ...
    public class TaskEntityConfiguration : IEntityTypeConfiguration<TaskEntity>
    {
        public void Configure(EntityTypeBuilder<TaskEntity> builder)
        {
            ...
            builder.HasQueryFilter(t =>
                (t.AssignedToNavigation == null || t.AssignedToNavigation.IsDeleted != true) &&
                (t.AssignedByNavigation == null || t.AssignedByNavigation.IsDeleted != true) &&
                t.CreatedByNavigation.IsDeleted != true &&
                (t.UpdatedByNavigation == null || t.UpdatedByNavigation.IsDeleted != true));
        }
    }
}