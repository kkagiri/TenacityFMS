...
public class VehicleDocumentUserPreferenceConfiguration : IEntityTypeConfiguration<VehicleDocumentUserPreference>
{
    public void Configure(EntityTypeBuilder<VehicleDocumentUserPreference> builder)
    {
        ...
        builder.HasQueryFilter(preference =>
            preference.User.IsDeleted != true &&
            preference.CreatedByNavigation.IsDeleted != true &&
            (preference.UpdatedByNavigation == null || preference.UpdatedByNavigation.IsDeleted != true));
    }
}