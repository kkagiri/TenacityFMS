...
{
    /// <summary>
    /// Database entity for mapping FMS devices to provider-specific device records.
    /// Supports tracking vehicle mappings and fueling device mappings.
    /// </summary>
    [Table("vehicle_provider_mappings")]
    public class DeviceProviderMappingEntity
    {
        /// <summary>
        /// Primary key
        /// </summary>
