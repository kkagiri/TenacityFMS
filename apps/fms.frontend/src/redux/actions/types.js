...
// Current user's own permissions (fetched via GET /Permission/me)
export const FETCH_MY_PERMISSIONS_REQUEST = "FETCH_MY_PERMISSIONS_REQUEST";
export const FETCH_MY_PERMISSIONS_SUCCESS = "FETCH_MY_PERMISSIONS_SUCCESS";
export const FETCH_MY_PERMISSIONS_FAILURE = "FETCH_MY_PERMISSIONS_FAILURE";

// 3-Audience Architecture — tenant context (claims read from JWT) + branding
export const SET_TENANT_CONTEXT = "SET_TENANT_CONTEXT";
export const SET_TENANT_BRANDING = "SET_TENANT_BRANDING";
export const CLEAR_TENANT_CONTEXT = "CLEAR_TENANT_CONTEXT";

export const FETCH_ROLE_DETAILS_REQUEST = "FETCH_ROLE_DETAILS_REQUEST";
...
export const RESET_ROLE_DETAILS_VIEW = "RESET_ROLE_DETAILS_VIEW";
