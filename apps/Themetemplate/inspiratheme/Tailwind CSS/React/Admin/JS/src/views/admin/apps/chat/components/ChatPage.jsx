                  ...
                  <Fragment key={idx}>
                    {currentContact.id === message.senderId && (
                      <div className="my-5 flex items-start gap-2.5">
                        {currentContact.image ? <img src={currentContact.image} className="size-9 rounded-full" alt="User" /> : <div className="bg-primary flex size-8 items-center justify-center rounded-full font-semibold text-white">{generateInitials(currentContact.name)}</div>}
                        <div>
