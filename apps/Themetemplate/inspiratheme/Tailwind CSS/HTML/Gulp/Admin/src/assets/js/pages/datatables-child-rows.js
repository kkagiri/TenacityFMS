...
function format(d) {
    ...
    return '<div class="grid md:grid-cols-3 items-center">' + '<div class="col-md-4">' + '<h5 class="fs-base mb-1">Rating:</h5>' + "<div>" + d.rating + "</div>" + "</div>" + '<div class="col-md-4">' + '<h5 class="fs-base mb-1">Status:</h5>' + `<span class="badge rounded-none ${d.status === "Bullish" ? "bg-success/15 text-succes" : "bg-danger/15 text-danger"}">${d.status}</span>` + "</div>" + '<div class="col-md-4">' + '<h5 class="fs-base mb-1">Extra info:</h5>' + "<div>And any further details here (images etc)...</div>" + "</div>" + "</div>"
}
            ...
            columns: [
                {
                    ...
                    orderable: false,
                    data: null,
                    defaultContent: '<svg  xmlns="http://www.w3.org/2000/svg"  width="22"  height="22"  viewBox="0 0 24 24"  fill="currentColor"  class="text-primary"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4.929 4.929a10 10 0 1 1 14.141 14.141a10 10 0 0 1 -14.14 -14.14zm8.071 4.071a1 1 0 1 0 -2 0v2h-2a1 1 0 1 0 0 2h2v2a1 1 0 1 0 2 0v-2h2a1 1 0 1 0 0 -2h-2v-2z" /></svg>',
                },
                { data: "company" },
                { data: "symbol" },
                { data: "price" },
