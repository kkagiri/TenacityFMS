            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="w-1/2">
                  ...
                  <button
                    className="btn btn-sm bg-primary hover:bg-primary-hover mt-5 text-white"
                    onClick={() =>
                      cutToClipboard({
                        current: document.querySelector('#cuttext'),
                      })
                    }
                  >
                    {lastCopied === 'cuttext' ? (
              ...
              <tr>
                ...
                <td className="w-1/2">
                  ...
                  <button
                    className="btn btn-sm bg-danger hover:bg-danger-hover mt-2 text-white"
                    onClick={() =>
                      cutToClipboard({
                        current: document.querySelector('#cutInput'),
                      })
                    }
                  >
                    {lastCopied === 'cutInput' ? (
