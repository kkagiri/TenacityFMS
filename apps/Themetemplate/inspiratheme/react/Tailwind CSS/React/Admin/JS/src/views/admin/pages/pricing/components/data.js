export const pricingPlans = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        label: 'Commercial project rights',
        included: true,
      },
      {
        label: 'Email support',
  ...
  },
  {
    ...
    features: [
      ...
      {
        label: 'All premium components & layouts',
        included: true,
      },
      {
        label: 'Commercial & SaaS usage rights',
        included: true,
      },
      {
        label: 'Dedicated support & onboarding',
        included: true,
      },
      {
        label: 'Custom Figma UI kits',
        included: true,
      },
      {
