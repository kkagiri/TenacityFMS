  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        Component: lazy(() => import('@/views/admin/apps/ecommerce/marketplace')),
      },
      {
      ...
      {
        path: '/metrics',
        Component: lazy(() => import('@/views/admin/metrics')),
      },
      {
        path: '/pages/account-settings',
        Component: lazy(() => import('@/views/admin/pages/account-settings')),
      },
      {
        path: '/pages/empty',
      ...
      },
      {
        ...
        Component: lazy(() => import('@/views/admin/plugins/loading-buttons')),
      },
      {
      ...
      },
      {
        ...
        Component: lazy(() => import('@/views/admin/plugins/text-diff')),
      },
      {
        path: '/plugins/tour',
