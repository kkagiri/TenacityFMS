...
const TransactionHistoryScreen = ({navigation}) => {
  ...
  const loadTransactions = useCallback((page = 1, refresh = false) => {
    const searchFilters = {
      ...filters,
      page,
      pageSize
  ...
  const handleDateChange = (event, selectedDate) => {
    ...
    if (selectedDate) {
      setTempFilters(prev => ({
        ...prev,
        [datePickerMode === 'start' ? 'startDate' : 'endDate']: selectedDate.toISOString().split('T')[0]
      }));
    }
  };
  ...
  const getStatusIcon = (status) => {
    switch (status?.toLowerCase()) {
      ...
      case 'authorized': return 'play-circle';
    ...
    >
      ...
      <View style={styles.transactionDetails}>
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailText}>
            Pump {item.pumpNumber} - {item.deviceName}
          </Text>
        </View>
        ...
        {item.vehicleId && (
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailText}>
              {item.vehiclePlate || item.vehicleId}
            </Text>
          </View>
        )}
        ...
        {item.tagId && (
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailText}>Tag: {item.tagId}</Text>
          </View>
        )}
      </View>
      ...
      <View style={styles.transactionAmounts}>
        ...
        <View style={styles.amountItem}>
          ...
          <Text style={styles.amountValueMoney}>{formatCurrency(item.amount)}</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
    ...
    <View style={styles.summaryCard}>
      ...
      <View style={styles.summaryGrid}>
        ...
        <View style={styles.summaryItem}>
          ...
          <Text style={styles.summaryValue}>{formatVolume(summary.totalVolume)}</Text>
        </View>
        <View style={styles.summaryItem}>
          <Text style={styles.summaryLabel}>Total Amount</Text>
          <Text style={styles.summaryValueMoney}>{formatCurrency(summary.totalAmount)}</Text>
        </View>
        <View style={styles.summaryItem}>
          <Text style={styles.summaryLabel}>Average/Transaction</Text>
          <Text style={styles.summaryValueMoney}>{formatCurrency(summary.averageTransactionAmount)}</Text>
        </View>
      </View>
    </View>
  );
        ...
        <View style={styles.modalContent}>
            ...
            <View style={styles.dateRow}>
              ...
              >
                ...
                <Text style={styles.dateButtonText}>
                  {tempFilters.startDate ? formatDate(tempFilters.startDate) : 'Start Date'}
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.dateButton}
              ...
              >
                <Icon name="calendar" size={16} color="#6b7280" />
                <Text style={styles.dateButtonText}>
                  {tempFilters.endDate ? formatDate(tempFilters.endDate) : 'End Date'}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.filterSection}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                onValueChange={(value) => setTempFilters(prev => ({...prev, pumpId: value}))}
                style={styles.picker}
              >
          ...
          <View style={styles.filterSection}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                onValueChange={(value) => setTempFilters(prev => ({...prev, sortBy: value}))}
                style={styles.picker}
              >
          ...
          <View style={styles.filterSection}>
            ...
            <View style={styles.sortOrderContainer}>
              ...
              >
                <Icon name="sort-amount-down" size={16} color={tempFilters.sortOrder === 'desc' ? 'white' : '#6b7280'} />
                <Text style={[
                  styles.sortButtonText,
                  tempFilters.sortOrder === 'desc' && styles.sortButtonTextActive
                ]}>Newest First</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
              ...
              >
                <Icon name="sort-amount-up" size={16} color={tempFilters.sortOrder === 'asc' ? 'white' : '#6b7280'} />
                <Text style={[
                  styles.sortButtonText,
                  tempFilters.sortOrder === 'asc' && styles.sortButtonTextActive
                ]}>Oldest First</Text>
              </TouchableOpacity>
            </View>
          </View>
