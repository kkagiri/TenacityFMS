...
def read_and_write_contents(folder_path, output_file):
    skip_folders = {'.git', '.github', '.vs', '.vscode', 'node_modules','packages', 'bin', 'obj','assests','build'}
...
output_file = "c:/Users/kkagiri/source/repos/Hyoung.Fms/TextContent/FMS.frontend.txt";
