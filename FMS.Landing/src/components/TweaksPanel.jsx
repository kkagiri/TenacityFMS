...
// Reusable Tweaks shell + form-control helpers (dev-only design tweak panel).
// Faithful port from the prototype host — postMessage protocol preserved so it
// continues to work inside the original prototyping host iframe. In a normal
// dev/prod page (no parent listener) it just sits idle until manually opened
// (it auto-opens in dev mode below).
...
export function TweaksPanel({
  ...
  if (!open) {
    // Floating launcher pill so dev users can re-open the panel.
    return (
      <>
