# Fuel Audit Implementation Documentation

This folder contains all implementation documentation for the Hybrid Fuel Audit System.
...
- [Hybrid Fuel Audit Algorithm](../hybrid_fuel_audit_algorithm.md) - Core algorithm specification
