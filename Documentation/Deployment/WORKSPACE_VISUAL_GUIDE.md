...
Step 1: DEVELOP
---------------
?? Location: C:\dev\Tenacity.FMS (or your local PC)
+---------------------------------+
...
+----------------------------------------------------------------------------+
¦  C:\dev\Tenacity.FMS         ¦  C:\actions-runner\_work\  ¦  C:\inetpub\     ¦
...
Morning:
  • Open C:\dev\Tenacity.FMS in VS Code
  • Make code changes
  • Test locally
...
Solution: cd C:\dev\Tenacity.FMS
