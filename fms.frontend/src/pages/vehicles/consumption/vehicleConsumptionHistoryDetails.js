...
import { fetchHistoryConsumptionByVehicle } from "../../../redux/actions/consumptionActions";
       ...
       const fetchData = async () => {
        ...
        { // Ensure vehicleId and date are present and no data has been loaded yet
          try {
                ...
                const response = await fetchHistoryConsumptionByVehicle(vehicleID,startDate,entry);
                setData(response);
            }
