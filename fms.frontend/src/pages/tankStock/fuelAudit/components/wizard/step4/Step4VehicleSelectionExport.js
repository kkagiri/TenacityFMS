...
export const CATEGORY_CONFIG = {
  1: {
    ...
    badgeColor: 'tw-bg-green-600 tw-text-white',
    confidence: 'HIGH',
  ...
  2: {
    ...
    badgeColor: 'tw-bg-yellow-500 tw-text-white',
    confidence: 'MEDIUM',
  ...
  3: {
    ...
    badgeColor: 'tw-bg-red-500 tw-text-white',
    confidence: 'LOW',
  ...
  4: {
    ...
    badgeColor: 'tw-bg-cyan-600 tw-text-white',
    confidence: 'HIGH',
  ...
  5: {
    ...
    badgeColor: 'tw-bg-gray-500 tw-text-white',
