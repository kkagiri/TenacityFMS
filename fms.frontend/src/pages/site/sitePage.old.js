...
const StatusCellRender = (data) => (
  <span
    className={`tw-px-2 tw-py-0.5 tw-rounded tw-text-xs tw-font-medium ${data.value
...
const StatusBadge = ({ isActive }) => (
  <span
    className={`tw-px-2 tw-py-0.5 tw-rounded tw-text-xs tw-font-medium ${isActive
        ? "tw-bg-emerald-100 tw-text-emerald-700"
        : "tw-bg-red-100 tw-text-red-700"
      }`}
  >
...
const SitePage = () => {
  ...
  const canCreateSite = hasPermission("_Manage_Site");
  const canEditSite = hasPermission("_Manage_Site");
  const canDeleteSite = hasPermission("_Manage_Site");
      ...
      <div className="site-details tw-animate-fadeIn tw-space-y-6">
          ...
          <div className="tw-flex tw-items-center tw-gap-4">
            ...
            <div className="tw-flex-1">
              ...
              <div className="tw-flex tw-items-center tw-gap-3 tw-mt-2">
                <span
                  className={`tw-px-3 tw-py-1 tw-rounded-full tw-text-xs tw-font-medium ${selectedSite.isActive
        ...
        <SectionCard title="GPSGate Tag Configuration" icon="fa-light fa-tags">
          ...
          <InfoRow
            ...
            value={
              <span
                className={`tw-px-2 tw-py-0.5 tw-rounded tw-text-xs tw-font-medium ${selectedSite.autoUpdateGpsGateTag
                    ? "tw-bg-emerald-100 tw-text-emerald-700"
    ...
    <div className="site-edit-form tw-animate-fadeIn tw-space-y-6">
      ...
      <div className="tw-bg-gradient-to-r tw-from-blue-600 tw-to-blue-700 tw-rounded-xl tw-p-6 tw-text-white tw-shadow-lg">
        <div className="tw-flex tw-items-center tw-gap-4">
          <div className="tw-w-16 tw-h-16 tw-rounded-full tw-bg-white/10 tw-flex tw-items-center tw-justify-center tw-backdrop-blur">
            <i
              className={`fa-light ${isCreating ? "fa-plus" : "fa-edit"
                } tw-text-3xl`}
            ></i>
          </div>
          <div>
