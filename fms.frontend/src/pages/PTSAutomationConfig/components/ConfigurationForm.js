...
const ConfigurationForm = ({ configuration, onSuccess, onCancel }) => {
  ...
  return (
    <div className="tw-h-full tw-flex tw-flex-col">
          ...
          <div className="tw-p-6">
            ...
            >
              ...
              <div className="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-border-gray-200">
                <div className="tw-bg-blue-50 tw-px-4 tw-py-3 tw-border-b tw-border-blue-100 tw-rounded-t-lg">
                  <h4 className="tw-text-md tw-font-semibold tw-text-blue-800 tw-flex tw-items-center">
              ...
              <div className="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-border-gray-200">
                <div className="tw-bg-green-50 tw-px-4 tw-py-3 tw-border-b tw-border-green-100 tw-rounded-t-lg">
                  <h4 className="tw-text-md tw-font-semibold tw-text-green-800 tw-flex tw-items-center">
                    <i className="fa-light fa-globe tw-mr-2"></i>
                    Scope Configuration
                  </h4>
                </div>
                <div className="tw-p-4">
              ...
              <div className="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-border-gray-200">
                <div className="tw-bg-purple-50 tw-px-4 tw-py-3 tw-border-b tw-border-purple-100 tw-rounded-t-lg">
                  <h4 className="tw-text-md tw-font-semibold tw-text-purple-800 tw-flex tw-items-center">
                    <i className="fa-light fa-robot tw-mr-2"></i>
                    Automation Settings
                  </h4>
                </div>
              ...
              <div className="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-border-gray-200">
                <div className="tw-bg-orange-50 tw-px-4 tw-py-3 tw-border-b tw-border-orange-100 tw-rounded-t-lg">
                  <h4 className="tw-text-md tw-font-semibold tw-text-orange-800 tw-flex tw-items-center">
              ...
              <div className="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-border-gray-200">
                <div className="tw-bg-teal-50 tw-px-4 tw-py-3 tw-border-b tw-border-teal-100 tw-rounded-t-lg">
                  <h4 className="tw-text-md tw-font-semibold tw-text-teal-800 tw-flex tw-items-center">
                    <i className="fa-light fa-balance-scale tw-mr-2"></i>
              ...
              {/* Status Section */}
              <div className="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-border-gray-200">
                <div className="tw-bg-gray-50 tw-px-4 tw-py-3 tw-border-b tw-border-gray-100 tw-rounded-t-lg">
                  <h4 className="tw-text-md tw-font-semibold tw-text-gray-800 tw-flex tw-items-center">
      ...
      <div className="tw-flex-shrink-0 tw-p-4 tw-border-t tw-border-gray-200 tw-bg-gray-50">
        <div className="tw-flex tw-justify-end tw-gap-3">
          ...
          <Button
            ...
            icon={configuration?.id ? "fa-light fa-save" : "fa-light fa-plus"}
          />
        </div>
      </div>
