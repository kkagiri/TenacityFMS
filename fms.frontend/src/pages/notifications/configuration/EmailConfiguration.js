...
const EmailConfiguration = () => {
  ...
  const handleConfigChange = (field, value) => {
    ...
    if (
      ["server", "port", "username", "password", "security"].includes(field)
    ) {
    ...
    <div className="email-config form-container">
      ...
      <div className="tw-flex tw-items-center tw-justify-between tw-mb-8">
        ...
        <div className="tw-flex tw-items-center tw-space-x-4">
          {/* Connection Status */}
          <div
            className={`tw-flex tw-items-center tw-space-x-2 tw-px-3 tw-py-1 tw-rounded-full tw-text-sm ${
              ...
              <ValidationGroup>
                <Form formData={config} colCount={2}>
                  ...
                  <SelectBox
                    ...
                    displayExpr="text"
                    onValueChanged={(e) =>
                      handleConfigChange("security", e.value)
                    }
                  />
                  ...
                  <TextBox
                    ...
                    onValueChanged={(e) =>
                      handleConfigChange("password", e.value)
                    }
          ...
          <div className="tw-space-y-6">
            ...
            <div className="tw-bg-blue-50 tw-border tw-border-blue-200 tw-rounded-lg tw-p-4">
              <div className="tw-flex tw-items-center tw-mb-2">
                ...
                <h4 className="tw-text-sm tw-font-medium tw-text-blue-900">
                  Quick Tips
                </h4>
              </div>
