    ...
    <div className="tw-p-4">
      <div className="tw-mb-4 tw-grid tw-grid-cols-1 lg:tw-grid-cols-[minmax(0,1fr)_auto] tw-gap-3 tw-items-start">
        ...
        <div className="tw-flex tw-items-center tw-gap-2 tw-flex-wrap tw-justify-end">
          <Button text="New group" icon="fa-light fa-plus" type="default" stylingMode="contained" onClick={onCreateGroup} disabled={!canManage} />
          <Button text="Edit group" icon="fa-light fa-pen-to-square" stylingMode="outlined" onClick={onEditGroup} disabled={!selectedGroup || !canManage} />
          <Button
