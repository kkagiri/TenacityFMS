...
export const createManualFuelRefill = async (refillData) => {
    try {
        const response = await axiosInstance.post("/fuelrefill", refillData);
...
export const getManualFuelRefillbyid = async (id) => {
    try {
        const response = await axiosInstance.get(`/fuelrefill/${id}`);
        return response.data;
    }
        catch (error) {
...
export const updateManualFuelRefill = async (id, refillData) => {
    try {
        const response = await axiosInstance.put(`/fuelrefill/${id}`, refillData);
        return response.data;
    }
        catch (error) {
...
export const deleteManualFuelRefill = async (id) => {
    try {
        const response = await axiosInstance.delete(`/fuelrefill/${id}`);
        return response.data;
    }
        catch (error) {
