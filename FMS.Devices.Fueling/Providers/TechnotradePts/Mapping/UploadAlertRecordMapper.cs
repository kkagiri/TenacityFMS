 ...
 *                notifications.
 * Dependencies:  FMS.Application.Handlers, FMS.Devices.Core.Routing
 * Last Modified: 2026-05-03
 *
 * Key Functions:
 * - BuildPayload(): Converts AlertRecordDto into AlertRecordMessage.
 */
...
public sealed class UploadAlertRecordMapper
    : PtsPacketMapperBase<AlertRecordDto, AlertRecordMessage>
{
    ...
    protected override AlertRecordMessage BuildPayload(TechnotradePtsPacketContext context, AlertRecordDto packetPayload)
    {
