...
public record UserDeleteCommand(string UserId):IRequest<bool>;
...
public class UserDeleteCommandHandler : IRequestHandler<UserDeleteCommand, bool>
{
     ...
     public UserDeleteCommandHandler(GpsdataContext context, ILogger<UserDeleteCommandHandler> logger)
     {
         _context = context;
         _logger = logger;
     }
