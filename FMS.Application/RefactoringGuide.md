...
- Move CQRS components (Commands/Queries) to relevant feature folders
- Move DTOs to respective feature/domain DTOs folders
- Move infrastructure code to Infrastructure folder
- Move common interfaces to Core/Common/Interfaces
- Move response models to Core/Common/Responses
...
|------------------|--------------|
| Command/DatabaseCommand/ | Features/{Domain}/Commands/ |
| Command/PTSCommand/ | Features/PTS/Commands/ |
| Queries/Database/ | Features/{Domain}/Queries/ |
| Queries/PTSQueries/ | Features/PTS/Queries/ |
| ModelsDTOs/ | Features/{Domain}/DTOs/ |
| Common/FMSResponse.cs | Core/Common/Responses/ |
