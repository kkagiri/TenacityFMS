...
using FMS.Infrastructure.websocket.Protocol;
using System.Linq;
...
namespace FMS.Application.Communication.webSocket
{
    ...
    public class PTSDeviceConnection : IPTSDeviceConnection
    {
        ...
        private readonly ConcurrentDictionary<string, TaskCompletionSource<PTSMessage>> _pendingRequests
                  = new ConcurrentDictionary<string, TaskCompletionSource<PTSMessage>>();
            ...
            )
        {
            ...
            _ipAdress = ipaddress ?? throw new ArgumentNullException(nameof(ipaddress));
            _webSocket = webSocket ?? throw new ArgumentNullException(nameof(webSocket));
            _bufferManager = bufferManager ?? throw new ArgumentNullException(nameof(bufferManager));
            _scopeFactory = scopeFactory ?? throw new ArgumentNullException(nameof(scopeFactory)); // <-- Assign scope factory
            _cancellationTokenSource = new CancellationTokenSource();
            _deviceConnectionTracker = deviceConnectionTracker ?? throw new ArgumentNullException(nameof(deviceConnectionTracker)); // Assign tracker
