/**
 * File: DashboardHub.Protocol.cs
 * Purpose: Manages dashboard SignalR protocol negotiation, telemetry, and connection lifecycle tracking.
 * Dependencies: DashboardHub shared services, ConnectionMonitor, SignalR groups, ILogger
 * Last Modified: 2026-03-11
 *
 * Key Functions:
 * - AcceptProtocol(): Negotiates protocol version for the current dashboard client.
 * - AcceptProtocolAdvanced(): Handles feature-aware protocol negotiation.
 * - OnConnectedAsync(): Registers active dashboard frontend connections.
 * - OnDisconnectedAsync(): Removes active dashboard frontend connections.
 */
using System;
