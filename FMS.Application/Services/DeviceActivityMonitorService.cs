...
namespace FMS.Application.Services
{
    public class DeviceActivityMonitorService : BackgroundService
    {
                    ...
                    if (originalStatus != determinedStatus)
                    {
                        ...
                        if (determinedStatus == "Disconnected")
                        {
                            ...
                            try
                            {
                                ...
                                // Clean up orphaned transactions and notify clients using the shared service
        ...
        // NOTE: CleanupOrphanedTransactionsAsync, SaveIncompleteTransactionsAsync, and OrphanedTransactionInfo
        // have been moved to the shared OrphanedTransactionCleanupService for reuse by PTSDeviceConnection
    }
