...
<head>
    ...
    <style>
        ...
        /* Signature */
        .sign-off { margin-top: 22px; padding-top: 6px; }
        .sign-off .company-line { font-weight: 700; text-transform: uppercase; margin-bottom: 46px; }
        ...
        .ack { margin-top: 22px; padding: 14px 0 10px; border-top: 1px solid #8f8f8f; font-size: 8.8pt; }
        .ack p { margin: 0; text-align: left; line-height: 1.65; }
        .ack-line { border-bottom: 1px dotted #000; display: inline-block; min-width: 160px; margin: 0 8px 0 4px; }

        /* Footer */
        .doc-footer { margin-top: 92px; padding-top: 14px; font-size: 7.3pt; color: #7a7a7a; }
        .doc-footer__directors { text-align: center; }
        .doc-footer__generated { text-align: right; margin-top: 10px; line-height: 1.4; }
    </style>
</head>
<body data-skip-fms-letterhead=""true"">
    ...
    <div class=""doc-footer"">
        <div class=""doc-footer__directors"">DIRECTORS: J. SCHWARTZMAN (CEO/CHAIRMAN), H SCHWARTZMAN</div>
        <div class=""doc-footer__generated"">
