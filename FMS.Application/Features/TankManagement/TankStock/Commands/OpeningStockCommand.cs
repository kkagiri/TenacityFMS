            ...
            try {
                ...
                if (existingOpeningStock != null) {
                    ...
                    if (closingStockAfterOpening == null) {
                        return new FMSResponseMessage (false, $"An opening stock already exists for this date {entryDate.Date:yyyy-MM-dd} without a subsequent closing stock. Please create a closing stock before adding another opening stock.");
                    }
