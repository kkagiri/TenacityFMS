/**
 * File: CreateEventExpressionRequest.cs
 * Purpose: DTO for creating a new EventExpression via API.
 * Dependencies: None
...
{
    /// <summary>
    /// Request body for creating a new EventExpression.
    /// </summary>
    public class CreateEventExpressionRequest
    {
