/**
 * File: ConfirmReceiptCommandHandler.cs
 * Purpose: Handles receiver confirming vehicle receipt: InTransit → Completed.
 *          Sets ReceivedAt, updates vehicle working site, GPSGate tags, and notifies creator.
 * Dependencies: EF Core, AutoMapper, IVehicleTransferNotificationService, IGpsGateTagTransferService
 * Last Modified: 2026-02-27
 *
 * Key Components:
 * - Handle(): Validates InTransit status, completes transfer, updates vehicle site, notifies sender.
 */
using System;
