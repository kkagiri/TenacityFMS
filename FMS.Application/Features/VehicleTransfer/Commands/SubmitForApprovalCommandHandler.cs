/**
 * File: SubmitForApprovalCommandHandler.cs
 * Purpose: Handles draft submission to workshop manager approval stage.
 * Dependencies: EF Core, AutoMapper, email service
 * Last Modified: 2026-02-26
 *
 * Key Components:
 * - Handle(): Changes Draft -> PendingApproval and dispatches approval email.
 */
using System;
