    ...
    public class EmailNotificationChannel : INotificationChannel
    {
        ...
        public async Task<bool> SendAsync(Noti.Notification notification, NotificationRecipient recipient, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                {
                    return await _emailService.SendEmailAsync(recipient.RecipientAddress, subject, customEmailBody, true, cancellationToken);
                }
        ...
        private static string? TryGetCustomEmailBodyFromData(string? dataJson)
        {
            ...
            try
            {
                ...
                return dataObject.Value<string>("EmailBodyHtml")
