/**
 * File: VehicleTripDetailDTO.cs
 * Purpose: Read model for a persisted vehicle trip group with its trip legs.
 * Dependencies: Vehicle trip leg DTO, vehicle movement profile enum.
...
public class VehicleTripDetailDTO
{
    ...
    public List<VehicleTripLegDTO> Trips { get; set; } = new();
}
