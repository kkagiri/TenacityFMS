...
namespace FMS.Application.Configuration
{
    ...
    public class FMSSystemSettings
    {
        ...
        /// <summary>
        /// Tank stock management settings
        /// </summary>
        public TankStockSettings TankStock { get; set; } = new();
    ...
    public class WorkScheduleSettings
    {
        ...
        {
            return TimeSpan.TryParse(WorkStartTime, out TimeSpan time) ? time : SystemConfiguration.DEFAULT_WORK_START_TIME;
        }
        ...
        {
            return TimeSpan.TryParse(WorkEndTime, out TimeSpan time) ? time : SystemConfiguration.DEFAULT_WORK_END_TIME;
        }
    }
    ...
    /// <summary>
    /// Tank stock management configuration
    /// </summary>
    public class TankStockSettings
    {
        /// <summary>
        /// Policy for handling future records when entering historical tank stock data
        /// Valid values: BLOCK, WARN_RECONCILE, WARN_RECALCULATE, ALLOW_RECALCULATE
        /// </summary>
        [Required]
        public string FutureRecordsPolicy { get; set; } = SystemConfiguration.DEFAULT_TANK_STOCK_FUTURE_RECORDS_POLICY;

        /// <summary>
        /// Show detailed warnings when future records are detected
        /// </summary>
        public bool ShowDetailedWarnings { get; set; } = SystemConfiguration.DEFAULT_TANK_STOCK_SHOW_DETAILED_WARNINGS;

        /// <summary>
        /// Maximum number of days back to check for future records
        /// </summary>
        [Range(1, 600)]
        public int MaxHistoricalDays { get; set; } = SystemConfiguration.DEFAULT_TANK_STOCK_MAX_HISTORICAL_DAYS;
    }
