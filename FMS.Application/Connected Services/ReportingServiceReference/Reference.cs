...
namespace ReportingServiceReference
{
    ...
    public partial class ReportingSoapClient : System.ServiceModel.ClientBase<ReportingServiceReference.ReportingSoap>, ReportingServiceReference.ReportingSoap
    {
        ...
        public System.Threading.Tasks.Task<ReportingServiceReference.GetReportsResponse> GetReportsAsync(ReportingServiceReference.GetReportsRequest request)
        {
            return base.Channel.GetReportsAsync(request);
        }
        
        public System.Threading.Tasks.Task<ReportingServiceReference.GenerateReportResponse> GenerateReportAsync(ReportingServiceReference.GenerateReportRequest request)
        {
            return base.Channel.GenerateReportAsync(request);
        }
        
        public System.Threading.Tasks.Task<ReportingServiceReference.FetchReportResponse> FetchReportAsync(ReportingServiceReference.FetchReportRequest request)
        {
            return base.Channel.FetchReportAsync(request);
        }
        
        public System.Threading.Tasks.Task<ReportingServiceReference.GetReportStatusResponse> GetReportStatusAsync(ReportingServiceReference.GetReportStatusRequest request)
        {
            return base.Channel.GetReportStatusAsync(request);
        }
        
        public System.Threading.Tasks.Task<ReportingServiceReference.CancelReportResponse> CancelReportAsync(ReportingServiceReference.CancelReportRequest request)
        {
            return base.Channel.CancelReportAsync(request);
        }
        
        public System.Threading.Tasks.Task<ReportingServiceReference.GetProcessingReportsResponse> GetProcessingReportsAsync(ReportingServiceReference.GetProcessingReportsRequest request)
        {
