...
using FMS.Infrastructure.EventBus;
    ...
    public class PumpService : IPumpService
    {
        ...
        private PumpStatusBase ParsePumpStatus(object commandData)
        {
            ...
            if (commandData is Newtonsoft.Json.Linq.JObject jObj)
            {
                ...
                return statusType switch
                {
                    ...
                    _ => throw new ArgumentException($"Unsupported pump status type: {statusType}")
                };
            }
        ...
        private string GetPumpStatusString(PumpStatusBase pumpStatus)
        {
            return pumpStatus switch
            {
                ...
                _ => throw new ArgumentException($"Unsupported pump status type: {pumpStatus.GetType().Name}")
            };
        }
