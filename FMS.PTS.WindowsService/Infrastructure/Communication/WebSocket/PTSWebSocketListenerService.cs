...
namespace FMS.PTS.WindowsService.Infrastructure.Communication.WebSocket
{
    ...
    public class PTSWebSocketListenerService : BackgroundService
    {
        ...
        private readonly DeviceConnectionTracker _connnectionTracker;
...

        {
            ...
            _frontendHubContext = frontendHubContext ?? throw new ArgumentNullException(nameof(frontendHubContext));
            _connnectionTracker = connectionTracker ?? throw new ArgumentNullException(nameof(connectionTracker));
        ...
        private async Task HandleWebSocketConnectionAsync(HttpListenerContext context, CancellationToken stoppingToken)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("WebSocket handshake from device {DeviceId}, Firmware: {Firmware}, Config: {Config}", deviceId, null, null);
                ...
                var deviceConnection = new PTSDeviceConnection(
                 ...
                 webSocketContext.WebSocket,
                  _bufferManager,
                  _frontendHubContext,
                  _scopeFactory, _connnectionTracker);

                // Use ConnectionManager instead of local dictionary
