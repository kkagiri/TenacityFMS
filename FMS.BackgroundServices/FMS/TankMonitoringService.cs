/**
 * File: TankMonitoringService.cs
 * Purpose: Periodically checks tank measurements and triggers alarm workflows.
 * Dependencies: GpsdataContext, IAlarmHandlerService, AlarmHandlerActiveAlarmIntegration, ILogger
 * Last Modified: 2026-01-19
 *
 * Key Functions:
 * - ExecuteAsync(): Runs the monitoring loop.
 * - CheckAllTankLevelsAsync(): Iterates tanks and evaluates conditions.
 * - CheckSingleTankAsync(): Evaluates an individual tank.
 */
using System;
using System.Linq;
